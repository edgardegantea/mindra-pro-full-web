        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;">
                <button @click="prevMonth"
                        style="padding:6px;border-radius:8px;border:1px solid #e2e8f0;background:#fff;cursor:pointer;display:flex;align-items:center;color:#64748b;"
    ...
    <div class="dash-col-sessions">
        ...
        <div x-show="selectedDate" x-transition
            ...
            <button @click="selectedDate = null; open = null"
                    ...
                    onmouseover="this.style.background='#e0e7ff'" onmouseout="this.style.background='none'">
                × Limpiar
            </button>
        </div>
