    ...
    <nav class="bg-white border-b border-slate-200">
        <div class="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="{{ route('dashboard') }}" style="display:flex;align-items:center;gap:8px;text-decoration:none;">
                {{--<img src="/assets/img/mindra1.jpeg" alt=""
                     style="height:36px;width:36px;border-radius:9999px;object-fit:cover;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.08);flex-shrink:0;">--}}
                <img src="/assets/img/mindra2.png" alt="Mindra"
            ...
            <div style="display:grid;grid-template-columns:1fr;gap:2rem;">
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                    <div style="display:flex;align-items:center;gap:10px;">
                        <img src="/assets/img/mindra1.jpeg" alt=""
                             style="height:36px;width:36px;border-radius:9999px;object-fit:cover;border:2px solid #c7d2fe;box-shadow:0 2px 8px rgba(99,102,241,.18);">
                    ...
                    <div>
                        ...
                        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:7px;">
                            <li><a href="{{ route('chat') }}"
                                   ...
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Chat con Mindra</a></li>
                            <li><a href="{{ route('dashboard') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Mi historial</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:7px;">
                            <li><a href="{{ route('legal.privacy') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Política de privacidad</a></li>
                            <li><a href="{{ route('legal.data-usage') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Uso de datos</a></li>
                            <li><a href="{{ route('legal.cookies') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Política de cookies</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:7px;">
                            ...
                            <li><a href="{{ route('legal.terms') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Términos de uso</a></li>
                            <li><a href="{{ route('legal.consent') }}"
                                   style="font-size:.8125rem;color:#64748b;text-decoration:none;"
                                   onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Consentimiento informado</a></li>
                        </ul>
                    </div>
